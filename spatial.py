...
pre_file = 'sinception_spatial2fc_{}'.format(n_neurons)
...
if (args.summary == 1):
    ...
    plot_model(result_model, to_file='Spatial_stream3.png', show_shapes=True)
    #plot_model(result_model, to_file='Spatial_stream.png')
    sys.exit()
