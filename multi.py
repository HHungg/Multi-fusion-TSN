...
parser.add_argument('-w', '--weights', help='Weights', default='imagenet')
...
def print_lr(models):
    print(K.eval(models.optimizer.lr))
...
if (args.summary == 1):
    ...
    plot_model(result_model, to_file='Two_stream1.png', show_shapes=True)
    sys.exit()
