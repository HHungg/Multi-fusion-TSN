...
def Inception_temp_v3a(include_top=False,
                weights='imagenet',
                input_tensor=None,
                input_shape=None,
                classes=1000,
    ...
    if weights == 'imagenet':
        model.load_weights('data/Temp_InceptionV3a.h5')
        print ('Loaded weights v3a')
...
def Inception_v3a(include_top=False,
    ...
    if weights == 'imagenet':
        model.load_weights('data/InceptionV3a.h5')
        print ('Loaded weights v3a')
...
def Inception_v3b(input_tensor=None, input_shape=None, pre='custom_', weights='imagenet', depth=3):
    ...
    if weights == 'imagenet':
        model.load_weights('data/InceptionV3b.h5')
        print ('Loaded weights v3b')
